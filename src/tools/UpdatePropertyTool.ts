...
class UpdatePropertyTool extends MCPTool<UpdatePropertyInput> {
    name = "update_property";
    description = "Update an existing property or prospect in Inmovilla";
    schema = {
        ref: {
            type: z.string(),
            description: "Reference of the property to update (Must be unique)",
        },
        keyacci: {
...
export default UpdatePropertyTool;
